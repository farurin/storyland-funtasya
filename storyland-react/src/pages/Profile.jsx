    ...
    <div className="w-full relative">
      <div className="max-w-6xl mx-auto px-6 pt-12 pb-10 min-h-[60vh]">
        ...
        <div className="flex justify-center mb-12 md:mb-16">
          <div className="bg-[#6B4EFF] w-full max-w-sm md:max-w-none md:w-auto p-1.5 rounded-2xl md:rounded-full shadow-md">
            <div className="grid grid-cols-2 md:flex md:items-center gap-1.5 md:gap-0">
              {tabs.map((tab) => (
                <button
                  key={tab}
                  onClick={() => setActiveTab(tab)}
                  className={`px-4 md:px-8 py-2.5 rounded-xl md:rounded-full font-bold text-sm md:text-base whitespace-nowrap transition-all ${
                    activeTab === tab
